            ...
            <div class="col-sm-4">
                <div class="box box-success text-center">
                    <div class="box-header">
                        <h3 class="box-title">PRESTASI AKADEMIK/NON AKADEMIK</h3>
                    </div>
                    <div class="box-body table-responsive">
                        <img src="{{ asset('adminlte/dist/img/user2-160x160.jpg') }}" alt="Prestasi">
                        <br>
                        <br>
                        <p>Selamat datang Calon Peserta Didik Baru di PPDB MTsN 2 Sleman Jalur Prestasi!
                            ...
                            3. Prestasi Tahfidz (memiliki hafalan Al-Quran minimal juz 30)</p>
                        <br>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    @if ($dateNow >= $setting->start_prestasi && $dateNow <= $setting->end_prestasi)
                        ...
                        @else
                            <center><a href="{{ route('user.pendaftaran_prestasi') }}" class="btn btn-success"> DAFTAR JALUR
                                    PRESTASI</a></center>
                        @endif
                    @else
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    @if ($dateNow >= $setting->start_reguler && $dateNow <= $setting->end_reguler)
                        ...
                        @else
                            <center>
                                <a href="{{ route('user.pendaftaran_reguler') }}" class="btn btn-success"> DAFTAR JALUR
                                    REGULER</a>
                            </center>
                        @endif
                    @else
